...
const STRIPE_KEY = "pk_test_51OoV0PSBO0NOdIdUvLNkpd8ax5b6Ls9H8jOyowqdt3h0U8bWLiwFsnXzHqEK6IHYXz9mhVvkj9GKr8dCoXlc3xZW00rNtBPUQi";
...
function BookShow() {
  ...
  const getSeats = () => {
    const columns = 12;
    const totalSeats = show.totalSeats; // defined while adding the show
